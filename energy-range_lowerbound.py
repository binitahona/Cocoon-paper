...
spectrum3.lower_bound_2 = 10 * u.TeV
spectrum3.lower_bound_2.fix = False
spectrum3.lower_bound_2.bounds = (0.07 * u.TeV, 50 * u.TeV)

spectrum3.upper_bound_2 = np.inf * u.TeV
spectrum3.upper_bound_2.fix = True
...
contours = jl.get_contours(spectrum3.lower_bound_2,0.4e9,3e9,10)
plt.savefig('cocoon_low.pdf')
