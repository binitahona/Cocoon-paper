...
spectrum3.xc = 20 * u.TeV
spectrum3.xc.fix = False
spectrum3.xc.bounds = (1 * u.TeV, 400 * u.TeV)
...
np.savez( "contours_cocoon_cutoff.npz",  a=np.array(a), b=np.array(b), cc=np.array(cc)  )
fig.savefig("contours_cocoon_cutoff.pdf")
limit.get_limit("contours_cocoon_cutoff.npz")
